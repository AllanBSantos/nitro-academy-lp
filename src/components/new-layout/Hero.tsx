...
export function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#19184b] via-[#1e1b4b] to-[#19184b] pt-20 md:flex md:items-center md:justify-center"
    >
      {/* Animated Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-10 w-72 h-72 bg-[#599fe9]/10 rounded-full blur-3xl animate-float"></div>
        <div
          className="absolute bottom-20 right-10 w-96 h-96 bg-[#f54a12]/10 rounded-full blur-3xl animate-float"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/3 w-64 h-64 bg-[#03A9F4]/10 rounded-full blur-3xl animate-float"
      ...
      <div className="absolute inset-0 opacity-10">
        <svg
          className="absolute top-1/4 right-1/4 w-32 h-32 text-[#599fe9]"
          viewBox="0 0 100 100"
        >
          <circle
            cx="50"
        ...
        <svg
          className="absolute bottom-1/4 left-1/4 w-24 h-24 text-[#f54a12]"
          viewBox="0 0 100 100"
        >
          <polygon
